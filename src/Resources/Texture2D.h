...
namespace sixday
{
	...
	namespace render
	{
		...
		{
			TEXTURE_2D_TYPE_ALBEDO   = 0, //¬˛∑¥…‰Ã˘Õº
			TEXTURE_2D_TYPE_SPECULAR = 1, //∏ﬂπ‚∑¥…‰Ã˘Õº
			TEXTURE_2D_TYPE_NORMAL   = 2, //∑®œﬂÃ˘Õº
			TEXTURE_2D_TYPE_BUMP     = 3, //∞ºÕπÃ˘Õº
			TEXTURE_2D_TYPE_SHADOW   = 4, //“ı”∞Ã˘Õº
